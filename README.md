...
- [x] In call chat
- [x] Call recording *(requires public URL - see [RECORDING_SETUP.md](RECORDING_SETUP.md))*
- [x] View call details
- [x] Rejoiing calls
- [ ] Call transcription
- [ ] Call limits
...
> **⚠️ Important Note on Recording:** Recording functionality requires your application to be accessible from the internet. It will not work on localhost. See [RECORDING_SETUP.md](RECORDING_SETUP.md) for setup instructions.
